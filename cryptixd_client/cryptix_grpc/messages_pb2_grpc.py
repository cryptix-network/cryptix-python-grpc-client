...
class RPCStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MessageStream = channel.stream_stream(
            ...
            request_serializer=messages__pb2.CryptixdRequest.SerializeToString,
            response_deserializer=messages__pb2.CryptixdResponse.FromString,
...
def add_RPCServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "MessageStream": grpc.stream_stream_rpc_method_handler(
            ...
            request_deserializer=messages__pb2.CryptixdRequest.FromString,
            response_serializer=messages__pb2.CryptixdResponse.SerializeToString,
        ),
    }
...
class RPC(object):
    ...
    def MessageStream(
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            "/protowire.RPC/MessageStream",
            messages__pb2.CryptixdRequest.SerializeToString,
            messages__pb2.CryptixdResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
